...
1. load the csv data.
```{r}
raw_data                     <- fread(file='simdata_57sub.csv') #load as data.table: https://digitaschools.com/read-csv-in-r-importing-data/
...
# 3. supporting variables: subid (n=5), trial(1:144)
```
...
save(fit_m3g,file ='./stan_output/fit_m3_Sim.RData')#非常重要！！！一定要在本地路径建相应文件夹stan_output
