...
# 数据准备
membership_inter_split <- read.csv("./individual_paras.csv")
...
para_plot <- ggplot(membership_inter_split, aes(x = split, y = para, fill = membership)) +
  ...
  scale_x_discrete(
    #labels = c("alpha" = "aversion to disadvantageous inequity", "theta" = "concerns for relative advantage", "beta" = "inflicted harm sensitivity"),
        #labels = c("alpha" = "aversion to disadvantageous inequity(α)", "theta" = "concerns for relative advantage(β)", "beta" = "inflicted harm sensitivity(θ)"),
