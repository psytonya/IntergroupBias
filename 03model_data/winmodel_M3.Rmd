...
1. load the csv data.
```{r}
raw_data                     <- fread(file='alldata_57sub.csv') #load as data.table
...
# 3. supporting variables: subid (n=57), trial(1:144)
```
...
fit_m3g <- stan(file=paste0(getwd(),'/stan_model/m3.stan'), data=data_list,
pars = pars_m3g,
chains = 3,
iter = 12000,
warmup = 6000,
...
save(fit_m3g,file ='./stan_output/fit_m3.RData')
...
#1.2. Rhat, must be below 1.01 to make sure that parameter estimates could be trusted (Baribault & Collins, 2022)Rhat<1.01
...
pars = paste0(c('mu_alpha11','mu_alpha12','mu_theta11','mu_theta12','mu_beta11','mu_beta12','mu_tau')),
