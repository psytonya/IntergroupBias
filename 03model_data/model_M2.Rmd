...
1. load the csv data.
```{r}
raw_data                     <- fread(file='alldata_57sub.csv') #load as data.table: https://digitaschools.com/read-csv-in-r-importing-data/
...
fit_m2g <- stan(file=paste0(getwd(),'/stan_model/m2.stan'), data=data_list,
pars = pars_m2g,
chains = 3,
iter = 12000,
warmup = 6000,
...
save(fit_m2g,file ='./stan_output/fit_m2.RData')#非常重要！！！一定要在本地路径建相应文件夹stan_output
