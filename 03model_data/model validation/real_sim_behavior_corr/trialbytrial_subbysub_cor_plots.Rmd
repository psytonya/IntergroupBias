...
fig_sub <- scatterplot2(all_data2[,c("real_data_sub","sim_data_sub")],c(0,4),seq(from=0,to=4,by=0.5),c(0,4),seq(from=0,to=4,by=0.5),c(0.4,0.2,0.4,0.6,0.8),xlabs='Actual behaviors(sub by sub)',ylabs='Model prediction(sub by sub)')
