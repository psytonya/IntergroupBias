...
# 读取数据并进行预处理
Main_effect_membership <- read.csv("./gPPI_F.csv")
...
ggplot(Main_effect_membership, aes(x = membership, y = Ventral_striatum_dACC, color = membership)) +
  ...
  theme(
    ...
    axis.title.y = element_text(size = 26, colour = "black", vjust = 0.5, family = "Arial"),
    axis.title.x = element_blank(),
    axis.text.x = element_text(size = 26, colour = "black",  family = "Arial", margin = margin(t = 8)),
    axis.text.y = element_text(size = 26, colour = "black",  family = "Arial"),
...
# 读取数据并进行预处理
Main_effect_membership <- read.csv("./gPPI.csv")
