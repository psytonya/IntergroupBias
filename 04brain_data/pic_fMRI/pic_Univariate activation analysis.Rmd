...
membership_inter_split <- read.csv("./Univariate activation analysis.csv")
...
Interaction_dACC_plot <- ggplot(membership_inter_split, aes(x = split, y = Interaction_dACC, fill = membership)) +
  ...
  theme(
    ...
    axis.title.y = element_text(colour = "black",size = 30, vjust = 0.5,  family = "Arial"),
    axis.text.x = element_text(colour = "black",size = 30,  family = "Arial", margin = margin(t = 8)),
    axis.text.y = element_text(size = 30,colour = "black", family = "Arial"),
...
# 保存图表
ggsave('./Fig3.C_dACC.png', Interaction_dACC_plot, width = w, height = h, dpi = 300, bg = "transparent")
```
...
# 保存图表
ggsave('./Fig3.B_mPFC.png', Interaction_rmPFC_plot, width = w, height = h, dpi = 300, bg = "transparent")
```
